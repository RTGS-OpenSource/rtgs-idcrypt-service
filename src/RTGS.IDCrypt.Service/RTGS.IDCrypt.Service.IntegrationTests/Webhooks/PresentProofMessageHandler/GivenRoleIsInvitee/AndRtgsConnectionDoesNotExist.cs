...
public class AndRtgsConnectionDoesNotExist : IClassFixture<RtgsConnectionDoesNotExistFixture>, IAsyncLifetime
{
	...
	public AndRtgsConnectionDoesNotExist(RtgsConnectionDoesNotExistFixture testFixture)
	{
	...
	public void WhenPosting_ThenReturnsErrorMessage() =>
		_httpResponse.Content.ReadAsStringAsync().Result.Should().Be(
			"{\"error\":\"No established RTGS connection found\"}");
}
