...
namespace RTGS.IDCrypt.Service.IntegrationTests.Controllers.BankConnectionController.GivenCreateConnectionInvitationRequest;
...
public class AndAgentAvailable : IClassFixture<ConnectionInvitationFixture>, IAsyncLifetime
{
	...
	public async Task InitializeAsync() =>
		_httpResponse = await _client.PostAsJsonAsync("api/bank-connection/create", _request);
