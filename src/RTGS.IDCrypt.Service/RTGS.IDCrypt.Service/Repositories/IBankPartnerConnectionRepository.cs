...
public interface IBankPartnerConnectionRepository
{
	...
	Task<IEnumerable<BankPartnerConnection>> GetMatchingAsync(Expression<Func<BankPartnerConnection, bool>> filterExpression, CancellationToken cancellationToken = default);
}
